...
if(isset($_SESSION["user_id"])){
    ...
    $matches = $resultMatches->fetch_all(MYSQLI_ASSOC);
...
<body>
    <section class="header">
        <nav>
            ...
            <div class="nav-links" id="navLinks">
                ...
                <ul>
                    <li><a href="marcador-real.php">Marcadores Reales</a></li>
    ...
    <div class="match">
        ...
        foreach($scores as $score){
            if($score["pot"] !== 'x'){
                echo('<div class="match-content">
                    <div class="column">
                        <div class="team team--home">
                            <div class="team-logo">
                            <img src="images/' . $score["team_a"] . '.png" alt="' . $score["team_a"] . '" height="100" width="140">
                            </div>
                            <h2 class="team-name">' . $score["team_a"] . '</h2>
                        </div>
                    </div>
                    ...
                    <div class="column">
                        <div class="team team--away">
                            <div class="team-logo">
                                <img src="images/' . $score["team_b"] . '.png" alt="' . $score["team_b"] . '" height="100" width="140">
                            </div>
                            <h2 class="team-name">' . $score["team_b"] . '</h2>
                        </div>
                    </div>
                </div>');
            }
            ...
            foreach($userQualifiers as $userQualifier){

    
                echo('<div class="match-content">
                        <div class="column">
                            <strong>Grupo ' . $userQualifier["pot"] . ':' . '</strong>
                        </div>
        
                        <div class="column">
                            <div>
                                <strong>Primer puesto: '  . $userQualifier["first"] . '</strong>
                            </div>
                        </div>

                        <div class="column">
                            <div>
                                <strong>Segundo puesto: '  . $userQualifier["second"] . '</strong>
                            </div>
                        </div>
                    </div>');
            }
