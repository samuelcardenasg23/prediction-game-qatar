...
$mysqli = require __DIR__ . "/database.php";
    ...
    $sqlUsersFalcon = "SELECT id, user_name, user_last_name FROM user WHERE ff_employee = 1"; 

    $resultsUsersFalcon = $mysqli->query($sqlUsersFalcon);
    $usersFalcon = $resultsUsersFalcon->fetch_all(MYSQLI_ASSOC);

    $sqlUsers = "SELECT id, user_name, user_last_name FROM user WHERE ff_employee = 0";
